...
In my approach, I will choose to establish an IAM role, which will hold significant privileges (including administrator access), and securely store the corresponding access keys within the kops instance. This strategic choice is grounded in the necessity for the IAM role to effectively engage with a diverse range of services, including S3 buckets and Route53. As a sequential step, I will establish a connection between this IAM role and the instance, ensuring seamless interaction
